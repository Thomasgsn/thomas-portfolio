  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className=" flex gap-20 w-[80vw] md:w-[60vw]">
        <div className="hidden lg:block bg-right w-[35rem] h-[35rem] bg-[url('/personnal_life/sport/sport_3.webp')] bg-cover rounded-md drop-shadow-2xl dark:drop-shadow-xl" />
